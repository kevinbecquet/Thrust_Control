...
static const _Thrust_type_support_symbol_names_t _Thrust_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, thrust_msgs, msg, Thrust)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, thrust_msgs, msg, Thrust)),
  }
};
...
{
  return &::thrust_msgs::msg::rosidl_typesupport_cpp::Thrust_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, thrust_msgs, msg, Thrust)() {
  return get_message_type_support_handle<thrust_msgs::msg::Thrust>();
}

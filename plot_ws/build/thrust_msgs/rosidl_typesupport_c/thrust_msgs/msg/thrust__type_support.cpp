...
#include "thrust_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Thrust_type_support_symbol_names_t _Thrust_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thrust_msgs, msg, Thrust)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thrust_msgs, msg, Thrust)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_thrust_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, thrust_msgs, msg, Thrust)() {
  return &::thrust_msgs::msg::rosidl_typesupport_c::Thrust_message_type_support_handle;
}
